...
# 添加第一个折线图轨迹
fig.add_trace(go.Scatter(x=curDuration1, y=m1, mode='lines+markers', name='curM1'), row=1, col=1)

# 添加第二个折线图轨迹
fig.add_trace(go.Scatter(x=curDuration1, y=m2, mode='lines+markers', name='curM2'), row=1, col=1)

fig.add_trace(go.Scatter(x=curDuration1, y=m3, mode='lines+markers', name='curM3'), row=1, col=1)

fig.add_trace(go.Scatter(x=curDuration1, y=s1, mode='lines+markers', name='curS1'), row=1, col=1)

fig.add_trace(go.Scatter(x=curDuration1, y=s2, mode='lines+markers', name='curS2'), row=1, col=1)
